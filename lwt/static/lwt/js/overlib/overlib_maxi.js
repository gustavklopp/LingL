...
function overlib() {
    ...
    if (over) {
        over = typeof over.id != "string" ? o3_frame.document.all["overlibDiv"] : over;
        cClick();
    }
    olHideDelay = 0;
    o3_text = ol_text;
...
function ol_content_simple(text) {
    ...
    var txt =
        ...
        'cellspacing="0" ' +
        (o3_fgclass ? 'class="' + o3_fgclass + '"' : o3_fgcolor + " " + o3_fgbackground + " " + o3_height) +
        '><tr><td valign="TOP"' +
        (o3_textfontclass ? ' class="' + o3_textfontclass + '">' : !olNs4 && cpIsMultiple ? ' style="' + setCellPadStr(o3_cellpad) + '">' : ">") +
...
function ol_content_caption(text, title, close) {
    ...
    if (close != "")
        closing =
            "<td " +
            (!o3_compatmode && o3_closefontclass ? 'class="' + o3_closefontclass : 'align="RIGHT') +
            '"><a href="javascript:return ' +
            fnRef +
            'cClick();"' +
            (o3_compatmode && o3_closefontclass ? ' class="' + o3_closefontclass + '" ' : " ") +
            closeevent +
            '="return ' +
            fnRef +
            'cClick();">' +
    ...
    txt =
        ...
        o3_border +
        '" cellspacing="0" ' +
        (o3_bgclass ? 'class="' + o3_bgclass + '"' : o3_bgcolor + " " + o3_bgbackground + " " + o3_height) +
...
function wrapStr(endWrap, fontSizeStr, whichString) {
    ...
    if (endWrap) return hasDims && !olNs4 ? (isClose ? "</span>" : "</div>") : "</font>";
        ...
        return hasDims && !olNs4
            ? isClose
                ? '<span style="font-family: ' + quoteMultiNameFonts(eval(fontStr)) + ";color: " + eval(fontColor) + ";font-size: " + fontSizeStr + ';">'
                : '<div style="font-family: ' + quoteMultiNameFonts(eval(fontStr)) + ";color: " + eval(fontColor) + ";font-size: " + fontSizeStr + ';">'
            : '<font face="' + eval(fontStr) + '" color="' + eval(fontColor) + '" size="' + (parseInt(fontSizeStr) > 7 ? "7" : fontSizeStr) + '">';
    }
}
...
function createDivContainer(id, frm, zValue) {
    ...
    if (divContainer == null) {
        if (olNs4) { // olNs4 = Old Netscape version 4 (usually 'false')
			// frm = Window
            divContainer = frm.document.layers[id] = new Layer(window.innerWidth, frm);
            objRef = divContainer;
        } else {
//            var body = olIe4 ? frm.document.all.tags("BODY")[0] : frm.document.getElementsByTagName("BODY")[0];
            var body = frm.document.getElementsByClassName("container-fluid")[0];
